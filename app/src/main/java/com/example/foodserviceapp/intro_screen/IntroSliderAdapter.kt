...
class IntroSliderAdapter(private val introSlides: List<IntroSlideDataClass>) :
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(introSlide: IntroSlideDataClass) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val layoutResId = if (viewType == 0) {
            ...
            R.layout.intro_screen_activity2 // Use the layout for the second slide
        } else {
            R.layout.intro_screen_activity3
        }
        return ViewHolder(
